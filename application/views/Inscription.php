...
<head>
    ...
    <link rel="stylesheet" href="<?php  echo site_url("assets/css/Profile-Edit-Form-styles.css"); ?>">
    <link rel="stylesheet" href="<?php echo site_url("assets/css/Profile-Edit-Form.css"); ?>">
</head>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group mb-3"><label class="form-label" style="color: var(--bs-white);">Firstname </label><input class="form-control" type="text" name="firstname" placeholder="first"></div>
                    </div>
                    <div class="col-sm-12 col-md-6">
...
<script src="<?php echo site_url("assets/js/Profile-Edit-Form-profile.js"); ?>"></script>
</body>
