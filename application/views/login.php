...
<?php if (isset($page) && $page == "client") { ?>
            <form action="<?php echo site_url("login/log") ?>"method="post" style="background: var(--bs-white);">
                ...
                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: var(--bs-gray-900);">Log In</button></div><a href="<?php echo base_url("login/signin"); ?>"><button class="btn btn-primary"  type="button" style="margin-left: 80px;background: var(--bs-gray-900);">Sign in</button></a>
